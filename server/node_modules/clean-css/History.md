...
* Fixed tests, [package.json](/client/package.json) for development, and regex
...
* Updated repository location and author information in [package.json](/client/package.json).
