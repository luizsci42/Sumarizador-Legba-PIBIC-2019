...
test('$NODE_PATH', function (t) {
    ...
    resolve('aaa', {
        ...
        t.error(err);
        t.equal(res, path.join(__dirname, '/node_path/x/aaa/server.js'), 'aaa resolves');
    });
    ...
    resolve('bbb', {
        ...
        t.error(err);
        t.equal(res, path.join(__dirname, '/node_path/y/bbb/server.js'), 'bbb resolves');
    });
    ...
    resolve('ccc', {
        ...
        t.error(err);
        t.equal(res, path.join(__dirname, '/node_path/x/ccc/server.js'), 'ccc resolves');
    });
