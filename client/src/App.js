          ...
          <div className="row">
            <div className="botoes">
              <h2>Consultas pré definidas</h2>
                ...
                <button onClick={texto => this.direcionar(texto='/consOito', 'SELECT obras.titulo FROM biblioteca.obras WHERE obras.titulo LIKE "F%"')}>Livros que começam com F</button>
